...
- **Night 3 is written but unplayed.** [`nothing-happens-after-eleven/`](nothing-happens-after-eleven/ADVENTURE.md) is `drafting` prep on a **working** date of Saturday 17 May 1986. The salvage crew, the shooting, Len's condition, and every end state are prepared situations, not events. The night deliberately ends with Lilly **certain** that Whitley protects the mill lot and **unable to prove it**; evidence and his walk belong to night 4. **Earl Voss is not bought** — the older campaign line calling his cruiser bought was wrong; he is asleep, not paid. The folder has **no `RUN.md`** and that is intentional.
...
- Current task: Authoring night 3, [`nothing-happens-after-eleven`](nothing-happens-after-eleven/ADVENTURE.md) (`status: drafting`). Its modular prep and quality gate are **complete**; `RUN.md` is deliberately not compiled.
- Last completed: campaign home for [`KCRK 102.3 FM`](world/locations/kcrk.md) and [`Mel Corwin`](world/npcs/mel-corwin.md) per [`docs/superpowers/specs/2026-09-21-kcrk-location-design.md`](../../docs/superpowers/specs/2026-09-21-kcrk-location-design.md) — location file, Mel NPC, Abigail employer pointer, `WORLD.md` / Ashgrove routing. Before that: the whole night-3 child except compile — front matter and premise, `plot.md` (SP1–SP6), `locations.md`, `secrets.md`, `characters.md`, `encounters.md`, the three `npcs/` crew files, and [`QUALITY.md`](nothing-happens-after-eleven/QUALITY.md) scored **110/120 Strong** with Coherence and Grounding passed. Persistent canon that night 3 needed was written into campaign `world/` (the new [`The Hoot Owl`](world/locations/the-hoot-owl.md), plus Whitley, Earl, Kevin, Len, Daisy, the precinct night line, Daisy's, and Cinder Creek Lumber). Campaign routing and the night 3 / night 4 arc split were corrected here, in [`CAMPAIGN.md`](CAMPAIGN.md), [`world/lore/revelation-ladder.md`](world/lore/revelation-ladder.md), and [`world/lore/timeline.md`](world/lore/timeline.md). Before that: Session 2 (*Vozes sem Corpo*) recap and promotion, 2026-09-21.
- Next concrete action: settle the two open mechanical decisions the child leaves tagged in [`nothing-happens-after-eleven/encounters.md`](nothing-happens-after-eleven/encounters.md) — the old-powder detonation `RULE UNCLEAR - GM DECISION REQUIRED` (Options A/B/C; Option A is the default if play starts without a ruling) and the printed SWADE row for Lilly's 9mm, which was left unpinned rather than silently editing her canonical sheet. **Compile `RUN.md` only when the GM asks for it**; compile is intentionally deferred and nothing is waiting on it.
- Files to open: [`nothing-happens-after-eleven/ADVENTURE.md`](nothing-happens-after-eleven/ADVENTURE.md), [`nothing-happens-after-eleven/encounters.md`](nothing-happens-after-eleven/encounters.md), [`nothing-happens-after-eleven/QUALITY.md`](nothing-happens-after-eleven/QUALITY.md), and the design authority [`docs/superpowers/specs/2026-09-21-nothing-happens-after-eleven-design.md`](../../docs/superpowers/specs/2026-09-21-nothing-happens-after-eleven-design.md). Station files when needed: [`world/locations/kcrk.md`](world/locations/kcrk.md), [`world/npcs/mel-corwin.md`](world/npcs/mel-corwin.md).
- Open GM questions: old-powder detonation authority and Lilly's 9mm runtime row (both above); whether to lift the `RUN.md` deferral. Still open from earlier: nausea / “something turned off at the tower” — mechanism unset; Ray’s “boss” unnamed.
- Open audit queue for takeover: none.
- Handoff note: `vozes-sem-corpo/RUN.md` is leftover prep. Recap wins. Night 3's folder is prep only — nothing in it has happened.
- Derived outputs needing refresh: none. Night 3 has **no** `RUN.md` and no `print/` output **by intent**; their absence is the current correct state, not a stale artifact.
...
| Next drafted night | Night 3, [`nothing-happens-after-eleven`](nothing-happens-after-eleven/ADVENTURE.md) — **drafting**; folder exists and is authored, `QUALITY.md` scored, **no `RUN.md` compiled** (deferred by GM). Working date Saturday 17 May 1986, months after night 2 | [`nothing-happens-after-eleven/ADVENTURE.md`](nothing-happens-after-eleven/ADVENTURE.md) |
...
| 5. Design intentions with no files | The nine `concept` rows in [Adventure inventory](#6-adventure-inventory) | No. These are jobs on the calendar, not written adventures. |
...
| Run the next session at the table | Night 3 is written but **not compiled**: read [`nothing-happens-after-eleven/ADVENTURE.md`](nothing-happens-after-eleven/ADVENTURE.md) → `plot.md` → `locations.md` → `encounters.md`. Do not run leftover `vozes-sem-corpo/RUN.md` as a sequel. | There is no night-3 `RUN.md`; compile from [`templates/adventure/SKELETON.md`](../../templates/adventure/SKELETON.md) when the GM lifts the deferral. |
...
| 3 | `nothing-happens-after-eleven` | Nothing Happens After Eleven | drafting | months later in 1986; working date Saturday 17 May 1986 | [exists](nothing-happens-after-eleven/ADVENTURE.md) | [`ADVENTURE.md`](nothing-happens-after-eleven/ADVENTURE.md), [`plot.md`](nothing-happens-after-eleven/plot.md), [`locations.md`](nothing-happens-after-eleven/locations.md), [`secrets.md`](nothing-happens-after-eleven/secrets.md), [`characters.md`](nothing-happens-after-eleven/characters.md), [`encounters.md`](nothing-happens-after-eleven/encounters.md), `npcs/`, [`QUALITY.md`](nothing-happens-after-eleven/QUALITY.md) 110/120; **no `RUN.md`** (compile deferred) | Unrelated action cop case at the Cinder Creek yard; its discovery trail can reach Whitley's local graft and leaves Lilly certain without proof. |
| 4 | `ashgrove-puzzle-1986` | (untitled; working) | concept | later 1986, after night 3 | none | no files | Puzzle night and arc-1 finishing rhyme; owns the graft evidence and Whitley's unfair walk; the 1986 personal bruise sits in the paperwork. |
...
| [Mel Corwin](world/npcs/mel-corwin.md) | Owner and station manager, KCRK 102.3 FM | 1986– | authored — not played (night 2 established an absent manager, not his name) |
...
| [The Hoot Owl](world/locations/the-hoot-owl.md) | Main Street pub; mill-crowd drinking nights | 1986–2016 | authored — not played |
| [KCRK 102.3 FM](world/locations/kcrk.md) | Local FM; Abigail's workplace; Mel's license | 1986– | mixed — studio/lot played on night 2; Mel's schedule and helper pool authored |
...
- **Whitley: planned exit versus played history.** Played: he is the 1986 chief; he shelved Loman; he signed the close (“Nice work, kid”). Planned only: local graft, being taken off the force by the end of the 1986 arc via an unfair walk, and civilian status by 1998. Do not narrate the exit as something that happened. The arc splits the discovery: **night 3 reaches certainty without proof and leaves him in the chair**; **night 4 owns the evidence and the walk**. Do not let night-3 prep hand the player a ledger, a confession, cash, or a packet that names him. See [`world/npcs/chief-whitley.md`](world/npcs/chief-whitley.md).
- **KCRK 102.3 FM was authored after session one.** Do not claim the player heard "102.3 FM" during night 1. Night 2 did play the station interior. The inland tower is a separate unmarked site off the lake road — not the KCRK building and not the printed powerline easement. Place: [`world/locations/kcrk.md`](world/locations/kcrk.md). Diegetic policy: [`MUSIC.md`](MUSIC.md).
