...
- Current task: Night 2 Grounding audit passed; compile `RUN.md` for the 2026-09-20 table. The adventure remains unplayed.
- Last completed: G32 layout, GM approved: timber-side chain-link flap (Ray's exit); live orange generator feeder across the shed doorway. All 36 grounding rows now have values.
- Next concrete action: Rebuild [RUN.md](vozes-sem-corpo/RUN.md) from [templates/adventure/SKELETON.md](../../templates/adventure/SKELETON.md) (Table flow / one home), folding in approved values and fixing the SP1 Notice vs duration discrepancy; then print.
- Files to open: [QUALITY.md](vozes-sem-corpo/QUALITY.md#grounding-audit), [plot.md](vozes-sem-corpo/plot.md), [secrets.md](vozes-sem-corpo/secrets.md), [locations.md](vozes-sem-corpo/locations.md), [encounters.md](vozes-sem-corpo/encounters.md), [templates/adventure/SKELETON.md](../../templates/adventure/SKELETON.md).
- Open GM questions: none on the grounding queue.
- Open audit queue for takeover: none. Compile is the remaining authoring job.
...
- Derived outputs needing refresh: [RUN.md](vozes-sem-corpo/RUN.md) and print outputs predate the approved values.
...
| 2 | `vozes-sem-corpo` | Vozes sem Corpo | drafting (preparation) | morning after night 1, Jan 1986 | [exists](vozes-sem-corpo/ADVENTURE.md) | **config** [`ADVENTURE.md`](vozes-sem-corpo/ADVENTURE.md) · **prep** [`plot.md`](vozes-sem-corpo/plot.md), [`locations.md`](vozes-sem-corpo/locations.md), [`encounters.md`](vozes-sem-corpo/encounters.md), [`secrets.md`](vozes-sem-corpo/secrets.md), [`characters.md`](vozes-sem-corpo/characters.md) · **quality gate** [`QUALITY.md`](vozes-sem-corpo/QUALITY.md) (coherence passed; [Grounding audit passed](vozes-sem-corpo/QUALITY.md#grounding-audit); RUN stale) · **table document** [`RUN.md`](vozes-sem-corpo/RUN.md), [`print/RUN.pdf`](vozes-sem-corpo/print/RUN.pdf) · **local NPCs** [`ray-holtz.md`](vozes-sem-corpo/npcs/ray-holtz.md), [`cal-briggs.md`](vozes-sem-corpo/npcs/cal-briggs.md), [`helen-loman.md`](vozes-sem-corpo/npcs/helen-loman.md), [`bud-ellison.md`](vozes-sem-corpo/npcs/bud-ellison.md) | The fresh call and the recording become a case. Only 1986 sequel. **Prepared outcomes are not history.** |
