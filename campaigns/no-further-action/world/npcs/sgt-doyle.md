...
- Pressure variants:
  ...
  - Threatened: Goes still, procedural, not theatrical.
  - Ignored: Does his paperwork. Does not narrate the plot to an empty room.

## Mechanics

- Wild Card or Extra: Extra until a night needs otherwise (not statted yet).
- Rank/role assumption: Veteran NCO-equivalent for a small PD, not a SWADE Rank Edge.
- Verified statistics: none yet — RULE UNCLEAR until a child adventure needs at-hand stats.
- Authority and page/section: SWADE Extra / Wild Card when written.
