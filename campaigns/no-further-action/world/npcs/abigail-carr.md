...
- **Role:** Local radio host / DJ at 102.3 FM (frequency authored after session one for ongoing continuity)
...
- **Fear:** unknown
- **Leverage/resources:** 102.3 FM, the recording, airtime, whoever else heard the log.
...
- First impression (phone, end of night 1): Practical, rattled enough to call the precinct, not a campfire ghost story.
...
- Avoid: Explaining the lake, naming projects, knowing Lilly’s childhood.
- Pressure variants: write when night 2 is designed.

## Mechanics

- Not statted. Night 2 will decide Extra vs Wild Card if she is on-screen.
