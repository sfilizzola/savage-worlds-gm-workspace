...
- **First impression:** broad workman in wet gloves, still doing the job while he talks
- **Voice/manner cue:** blunt boundaries and physical facts; no bureaucratic cover story
- **Spoken lines:**
  - “Road's closed. Turn around.”
  - “Badge stays outside.”
  - “Ray talks when he's scared. Doesn't make him right.”
- **Avoid:** technical explanation, theatrical threats, a full confession, knowledge of remote ownership
- **Pressure variants:**
  - **Cooperate:** Sets down what is in his hands only when escape is visibly closed. “Cuffs, then. Do it.”
  - **Refuse:** Keeps working. “No.”
  - **Threatened:** Squares up and looks past Lilly toward the truck.
  - **Ignored:** Keeps preparing the body and truck; if warning reaches him, he burns the log, starts the wipe, loads Frank, and drives.

## Mechanics

- **Wild Card or Extra:** Extra
- **Rank/role assumption:** strong civilian enforcer suited to opposing one Novice Wild Card alongside one noncombat technician
- **Verified statistics:**
...
Personality: economical, controlling, and focused on finishing the cleanup
Authority: SWADE Fifth Printing (2023), pp.10–11 (derived statistics), pp.87–88, 95 (Extras), p.202 (creating NPCs)

- **Gear/abilities:** no firearm and no prepared improvised-weapon value. If the GM turns a tool into a weapon, use `RULE UNCLEAR - GM DECISION REQUIRED` rather than inventing damage.
