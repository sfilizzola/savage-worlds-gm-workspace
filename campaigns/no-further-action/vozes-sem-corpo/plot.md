...
| `Athletics` to cross wet structure or secure the moving truck | Lilly falls prone or loses one round; no automatic injury. | She reaches the body, truck, or cutoff before the next cleanup step. | She also gains Cover or disconnects movement without damaging evidence. |
