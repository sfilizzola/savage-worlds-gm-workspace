...
| Trait | Fail | Success | Raise |
|---|---|---|---|
| `Notice` entering the compound | Lilly sees only one threat before action; a dragging seam still leads to the outbuilding. If unalerted, her presence is detected after this observation. | She spots Cal, the body route, and the signal rack. If alerted, she identifies the active wipe. | She also sees Ray's escape line or a live cable hazard before it is used and, if unalerted, remains unnoticed through one immediate action. |
