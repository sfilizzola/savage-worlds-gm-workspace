# Operation Hinterland - RUN

> Compiled table document. Source files remain authoritative. Rebuild this file when verified prep changes. This file must satisfy `templates/adventure/SKELETON.md`.
...
| Rank                   | Seasoned                                                                                                                                                                                                                                           |
| Players                | 4                                                                                                                                                                                                                                                  |
| PC mode                | pregenerated                                                                                                                                                                                                                                       |
| Active setting modules | Weird War II                                                                                                                                                                                                                                       |
| Supernatural level     | none                                                                                                                                                                                                                                               |
...
Shorthand used in this file. Not player-facing unless you choose to say it.


| Term              | Means                                                                                                                                                                                                  |
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Hydra**         | The whole rear signals station. Not one building.                                                                                                                                                      |
| **Head**          | One killable part. There are **three**: **board** (Altrathausplatz), **loft** (Grüner Turm), **books** (Brandt’s satchel). Cut **any two** and the hydra dies. Hitting one and leaving is not the job. |
| **False head**    | The Rathaus. Ward pins it. Cutting it does **not** count.                                                                                                                                              |
| **Wounded hydra** | One real head off, two still live. It can still scream.                                                                                                                                                |
| **Scream**        | The hydra calling for help: landline from the board, radio from the loft, or papers still useful enough to pass traffic.                                                                               |
| **Dummy site**    | Same as false head. Empty as an exchange. Officers may still keep an office there.                                                                                                                     |
| **Planned DZ**    | West / Segringer Tor. What Ward marks in the briefing.                                                                                                                                                 |
| **Actual LZ**     | East / Wörnitz, south of Wörnitztor. Mark **after** they orient. Not a briefing mark.                                                                                                                  |
| **Fuse**          | Stein and/or Keller starting a local hunt or curfew. Not a battalion arriving. Out-of-town help needs a living path **and** time.                                                                      |


**Hydra tracker (GM):** □ board (Altrathausplatz)  □ loft (Grüner Turm)  □ books (Brandt / satchel). Any **two** off = hydra dead. One off = wounded; it can still scream. Rathaus does not get a box.
...
GM throughline of the night. Do **not** speak this as the landing. Story-point **Mood (table)** is what you paraphrase when that situation is on.

Calm briefing in Pont-à-Mousson, then a truck, then weather that is not the classroom, flak under the flight, then snow on the unplanned face of a sleeping walled town. Two heads. That is the whole job.
...
- **Player objective:** kill the hydra (any two of board, loft, books). The Rathaus does not count.
- **GM intent:** calm briefing, rough jump, improvisation after a stale target pack; hollow town; no occult; gender not a question.
- **Immediate stakes:** short night; they are not on the rehearsed face; dummy building wastes time; a living hydra can scream.
- **Starting decision:** after they orient on the east face — how to close from the unplanned water side.
...
| Who                                             | Where                                               | Doing                                                                     |
| ----------------------------------------------- | --------------------------------------------------- | ------------------------------------------------------------------------- |
| Keene, Krajewski, Vasseur, Lang                 | East LZ, outside, south of Wörnitztor               | Together; must orient                                                     |
| Capt. Ellis Ward                                | Off-map (Pont-à-Mousson)                            | Gone                                                                      |
| 2 gate watch (Volkssturm / convalescent Extras) | Wörnitztor gatehouse                                | Stove, thin, not a fight they must take                                   |
| Gefr. Lina Hofmann                              | Rathaus, ground floor                               | Late clerk, one lamp, cold                                                |
| Hptm. Friedrich Stein                           | Quarters on or just off Weinmarkt, near the Rathaus | Off the floor unless woken                                                |
| Oblt. Marta Keller                              | North wall-walk, Rothenburger Tor–Grüner Turm       | Slow night round                                                          |
| 2 signals operators (Extras)                    | Altrathausplatz exchange                            | Live board, low traffic                                                   |
| 1 loft watch (Extra)                            | Grüner Turm                                         | Cold, aerial live                                                         |
| Fw. Otto Brandt                                 | Billet on **Nördlinger Straße** (SE)                | Papers in a satchel in the room                                           |
| Pvt. Louis Benoit                               | Cellar off Altrathausplatz                          | Hidden; not the only intel                                                |
| Cpl. Pieter Voss                                | Off-map until re-entry                              | Reserve                                                                   |
| Civilians                                       | Houses                                              | Blackout, a few late windows                                              |
| Bahnhof                                         | East, outside                                       | Empty or one sleeper. Map's 15-man watch is stale. **Not a fourth head.** |


No one else is required to be on the street.
...
| ------------------------- | ----------------------------------------------------------------- | ----------------------------------------------------------------- |
| Opening (first 10–15 min) | Briefing compressed; jump spectacle; they orient on the east face | Skip kit ask and extra chat; they are on the snow reading the map |
| Midpoint                  | Dummy site is wrong or they have read the town; one head in play  | Dummy building is one short read, not a crawl                     |
| Climax window             | Second head while the fuse is live                                | Do not skip this for a leftover room fight; compress, do not omit |
| Final quarter             | Out under the cost they earned                                    | Collapse extraction to cost, not a second map                     |


### Five-beat dashboard

Not a visit order. Jump to the situation they are in. Scores: `QUALITY.md` (98/120).
...
**3–4 hour core:** compress SP0+0b; SP1 as one close after they orient; dummy as a short read or skip; two heads; compressed exit under the fuse. Cut civilian linger, officer capture, long chase, second town.
...
| ---------------------- | ------------------------------------------------------------------------- | -------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- |
| `Notice` (the sheet)   | Civic pile circled; west fields named as the drop.                        | Water is drawn on the **east** of the picture. Remember that.                    | The Rathaus is a civic block, not a marked radio. November date is on the face. |
| `Persuasion` (kit ask) | Ward or the shed says no, or they get nothing useful. Team kit unchanged. | Ordinary extra: spare mag, gloves, a lamp, extra cutters, or one extra ½-lb TNT. | Same class of extra, a little faster. No second satchel. No live-head intel.    |
...
| Trait                                | Fail                                                                   | Success                      | Raise                                                                         |
| ------------------------------------ | ---------------------------------------------------------------------- | ---------------------------- | ----------------------------------------------------------------------------- |
| `Athletics` (chute; **flavor only**) | Ugly ride: twisted lines, tracer close, a hard opening. **Same snow.** | Clean enough. **Same snow.** | A moment of ugly beauty — flak, a dark shape of walls far off. **Same snow.** |


- **GM Note:** Ignore Wounds, Fatigue, lost gear, scatter, and any raise that would improve the LZ. Ignore Wild Die results that would change the night. They land **together**. The town stays asleep. Jump Qualified is not used.
- **Pressure/escalation:** none on Dinkelsbühl. Cut to snow.
- **Essential information and vectors:** the drop did not go as rehearsed; they are still four. The aircraft; the weather; the dark. No Notice gate to be allowed to land.
- **Failure changes:** uglier description. Same ditch.
...
| Trait                                                              | Fail                                                                                                         | Success                                                                       | Raise                                                                                                           |
| ------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------- |
| `Notice` (Dark −4)                                                 | Water is still there. The map still draws water on the east. No lamp, no better angle.                       | Lamp or movement at Wörnitztor; that is the near gate. This is not Segringer. | From a better angle, a stick of aerial on Grüner Turm (north wall). That is a **head** — the aerial they were told to find. Bahnhof is empty of the map’s 15-man watch. |
| `Survival` (Lang: Woodsman +2 in tree line / fields only)          | They can still walk. Lingering exposed can later cost Fatigue (p.125), not a hidden tax at the first minute. | A ditch, postern, or short circuit exists; Segringer is the long west walk.   | A close that does not require standing in the gate passage.                                                     |
| `Stealth` vs gate `Notice d4`                                      | Challenged. Shout seed. Bypass still exists.                                                                 | They pass or watch the stove without a fight.                                 | Two tired voices. The town is thin.                                                                             |
...
| Trait                   | Fail                                                                                     | Success                                                                                                   | Raise                                                                                                        |
| ----------------------- | ---------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------ |
| `Notice`                | Civic pile, quiet, no aerial **here**, no hum. A rushed glance may still read “military enough.”  | Not an exchange. Dead wire stub or cut-over tag in a closet or cellar points **east**, not at the church. If they have a north view (street, stair, window): a stick of aerial on the north wall still live — that is the **loft**. | Leftover note: *work* to the old post / Altrathausplatz; *books* with the signals NCO toward **Nördlinger**. |
...
| Trait         | Fail                                            | Success                                             | Raise                                                                                                                                         |
| ------------- | ----------------------------------------------- | --------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| `Notice`      | A warm working room.                            | Live switchboard. This is not the Rathaus.          | Loft on the north wall (Grüner Turm); papers with Brandt toward Nördlinger. A smashed board with no papers and a live aerial is **one** head. |
| `Electronics` | They can still smash, cut, kill power, or fire. | They can still raise out of town if the loft lives. | Landline scream is possible if loft and papers live. Repair of electronic gear is Limited by Electronics (p.34).                              |
...
| Trait                                 | Fail                                                        | Success                                                           | Raise                                                                                  |
| ------------------------------------- | ----------------------------------------------------------- | ----------------------------------------------------------------- | -------------------------------------------------------------------------------------- |
| `Notice` (Pitch Darkness −6 if unlit) | Cold cellar, stolen food.                                   | A hidden man; east quarter is where signals people live and work. | Rathaus is officers, not the board. Anything else he knows is extra, not load-bearing. |
| `Persuasion`                          | He stays hidden or runs. Heads remain findable without him. | Contact; extra eyes.                                              | He will not walk them to every head unless the table makes that true.                  |
...
| Trait                              | Fail                                                                                                                      | Success                                               | Raise                                                                              |
| ---------------------------------- | ------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------- | ---------------------------------------------------------------------------------- |
| `Notice`                           | A tall north tower, wind.                                                                                                 | Aerial or feed visible. The church is not the aerial. | Feed-line join at the base or wall-walk; a runner path toward the board or Brandt. |
...
| Trait                   | Fail                                                                                                                                               | Success                                                              | Raise                                                                                                       |
| ----------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------- |
| `Notice`                | Stove, cot, a satchel or drawer.                                                                                                                   | Live books / last traffic in the satchel.                            | Rathaus is not the exchange; board on Altrathausplatz; loft is the north tower; he can name Stein / Keller. |
| `Persuasion`            | He keeps or moves the bag. Other heads remain.                                                                                                     | Steal, freeze, or they learn burn / scatter counts; he need not die. | He names the board and loft.                                                                                |
...
| Trigger/time            | Change in situation | Visible warning                      | Effect on objective                         |
| ----------------------- | ------------------- | ------------------------------------ | ------------------------------------------- |
| Time on the dummy site  | Night shortens      | Empty rooms, leftover wire           | Hydra still up                              |
| One head dead, two live | Hydra wounded       | Traffic stutters; watch moves papers | Can still scream                            |
| Two heads dead          | Hydra gutted        | Silence, or a hunt with no call      | Main job done                               |
| Dawn                    | More eyes           | Light, smoke, gates waking           | Extraction expensive                        |
| Officers lit            | Local hunt / curfew | Named people moving                  | Out-of-town help only if a path still lives |
| Linger exposed          | Cold tax            | Fatigue, ice, shorter night          | Time spent is time the hydra still works    |
...
| ----------------------------------------------- | ------------------------------ | ----------------------------------------------- | -------------------------------------------------------- |
| Long way around the walls                       | Lost time                      | Closer gate later                               | Any head                                                 |
| Kit ask refused                                 | Team kit unchanged             | They still jump                                 | Planned DZ + Rathaus already marked                      |
| Ugly jump roll                                  | Description only               | Same snow, together                             | Story Point 1                                            |
| Failed Notice at the LZ                         | No lamp, no aerial yet         | Water still on the map and in front of them     | Survival; Lang names the near gate; they can still close |
| Wreck only dummy site                           | Noise, no kill                 | Leftover still points onward                    | Two real heads                                           |
| Botched loft climb                              | Noise, setback, not a bench    | Feed line, another approach                     | Other two heads                                          |
| NCO flees with bag                              | Papers in motion               | Chase or hit the other two                      | Switchboard + loft                                       |
| Loud first fight                                | Fuse starts                    | Hunt; civilians                                 | Remaining heads; leave after                             |
| Hofmann freezes or dies                         | Dummy leftover dies            | Wire stub, tag, empty board room                | Real heads by reading the town                           |
| Brandt burns the books                          | That head may die without them | Smoke, empty drawer, his flight                 | Board + loft; do not hide the sign                       |
| They win the east board in ten minutes and stop | False full success             | Aerial still live and/or papers not in the room | Remaining heads                                          |


## PC spotlight and safety

- Opening hard-removal: mitigated (jump is flavor only; together in cover; no required fight). Orientation is not a single Notice gate. Wrong-face correction is short and not a fall-to-death gate. Dummy building is optional and not a fortress. First violence has an out (break contact, civilians, thin watch).
- Replacement/re-entry: fifth pregen **Cpl. Pieter Voss** (missed this lift; finds the team after the first hour, or starts as a fifth). Allied Extra **Pvt. Louis Benoit** (cellar / loft / dummy-site office). Neither is the only intel source. Captured PC becomes a mobile stake the others can reach the same night, or the player takes the reserve immediately. Do not leave a player in the hall.
- Full lethality: after they have acted in town and the fuse is visible (shots, a hunt, a loft fight, papers on the run). Communicate it. Not invisible immunity in the opening, and not a coin-flip corpse before they have played.
- Spotlight hooks: Slot 1 (Keene) approach and not splitting — starts in the briefing room. Slot 2 (Krajewski) making a head stay dead — counts charges at the table. Slot 3 (Vasseur) reading the net — November date in the pack. Slot 4 (Lang) ground and recovery — names Segringer, then Wörnitztor.
- Hindrance cues (not unique keys): Keene — Heroic, Loyal, Stubborn (hold the four; do not spend them on the dummy). Krajewski — Driven, counts charges aloud. Vasseur — Curious, Cautious (stale package; she can still smash). Lang — Heroic, names every gate. Relationships: Keene trusts Lang’s eyes; needs Krajewski’s wrecking; German overlap with Vasseur so talk is not one PC.

World rule: gender is not a question. No gendered cover assignment. Civilian coats and papers are team tools.

### PC combat cards

All: Human, Wild Card, Pace 6, Size 0, 3 Bennies. Helmet +2 vs head Called Shots (RUL-2026-08-29-01). Toughness 5. Native language d8.

**Team kit (anyone may use):** 2× small satchel charge, 4× ½-lb TNT, wire cutters, 4× civilian coats and papers. Anyone may set a charge; Repair is the SWADE demo skill. Repair of electronic gear is Limited by Electronics (p.34).


| Weapon             | Range    | Damage | RoF | Shots | Notes           |
| ------------------ | -------- | ------ | --- | ----- | --------------- |
| M1 Carbine         | 15/30/60 | 2d6    | 1   | 15    | Semi-Auto       |
| Colt M1911A1       | 12/24/48 | 2d6+1  | 1   | 7     | AP 1, Semi-Auto |
| Mk2 grenade        | 5/10/20  | 3d6    | —   | —     | MBT (Athletics) |
| Sten               | 12/24/48 | 2d6−1  | 3   | 32    | AP 1, Auto      |
| Enfield No. 2 Mk 1 | 12/24/48 | 2d6−1  | 1   | 6     | Revolver        |
| TNT (½-lb)         | 5/10/20  | 2d6+1  | —   | —     | MBT             |
| Small satchel      | 3/6/12   | 4d6    | —   | —     | LBT             |


Auto fire (Sten / MP40) takes Recoil −2 (SWADE p.105) unless the shooter does not move and has Rock and Roll! (none of the PC sheets do). WW2 Rank extra Benny / +2 Toughness is **not** on these sheets. Rank is flavor.

**1st Lt. Jack Keene (U.S.) — Extra profile n/a; Wild Card PC.** Parry 5. Ag d8, Sm d8, Sp d6, Str d6, Vi d6. Athletics d8, Notice d8, Persuasion d6, Stealth d6, Fighting d6, Shooting d8, Battle d6, German d6. Edges: Alertness, Command, Extraction. Gear: M1 Carbine, M1911A1, 2× Mk2, knife, binoculars, winter kit, helmet, briefing map. Command aids Extras in range, **not** fellow Wild Cards without Natural Leader (p.45).

**Sgt. Tomasz Krajewski (Polish).** Parry 5. Ag d6, Sm d8, Sp d4, Str d8, Vi d6. Athletics d6, Notice d8, Stealth d6, Fighting d6, Shooting d8, Repair d8, Electronics d6. Edges: Soldier, Mr. Fix It, McGyver, Combat Reflexes. Gear: M1 Carbine, M1911A1, knife, tool roll; uses **team** satchels/TNT. Fire, smash, and cut still work if Repair fails.

**Sgt. Hélène Vasseur (Free French).** Parry 5. Ag d6, Sm d8, Sp d6, Str d4, Vi d6. Athletics d6, Notice d8, Persuasion d6, Stealth d6, Fighting d6, Shooting d6, Electronics d8, Repair d8, Healing d6; German d6, English d6, Polish d6, Italian d6. Edges: Alertness, Linguist, Mr. Fix It, Combat Reflexes. Gear: Sten, Enfield No. 2 Mk 1, knife, field telephone / tap kit, winter kit, helmet. Verbal skills Limited by Language (p.32). Talk is not required.

**Cpl. Beatrice "Bee" Lang (British).** Parry **2** (no Fighting). Ag d8, Sm d6, Sp d8, Str d4, Vi d6. Athletics d6, Notice d6, Stealth d8, Shooting d6, Healing d8, Survival d8, German d4. Edges: Alertness, Healer, Woodsman, Extraction. Gear: Sten, Enfield No. 2 Mk 1, knife, medical kit, winter kit, helmet. Do not stand in melee. Woodsman +2 Stealth in the wild only.

**Reserve — Cpl. Pieter Voss (Dutch).** Parry 5. Ag d8, Sm d6, Sp d4, Str d6, Vi d6. Athletics d6, Notice d6, Stealth d8, Fighting d6, Shooting d6, Thievery d6, Repair d8, German d6. Edges: Thief, Extraction, Mr. Fix It, Combat Reflexes. Gear: Sten, Enfield No. 2 Mk 1, knife, lock picks / pry bar, winter kit, helmet.

Full builds: `characters.md` (party) and `characters/` (one WW2-style sheet per PC).
...
Authority: SWADE Fifth Printing (2023), p. 65 Armor (torso unless Called Shot);
  pp. 98–99 Called Shot head/vitals −4, +4 damage; face of open-faced helmet −5
  bypasses helmet; p. 66 Snapfire −2 if the shooter moved; p. 93 grenades use
  Athletics; p. 95 Extras Incapacitated by one Wound; p. 89 GM Bennies may be
  spent on non-Wild Cards; p. 102 Illumination; p. 105 Auto / Recoil −2;
  p. 34 Repair includes demolitions; p. 32 verbal skills Limited by Language
Setting: Weird War II p. 14 steel helmet Armor +2; pp. 41, 52, 60, 152 weapons;
...
Each live head is GM-copy only (`maps/README.md`). Do not put those marks on Handout A.

## GM secrets

Clearly GM-only. Predetermined truths, not session history. Full text: `secrets.md`.

1. **The briefing named the wrong building.** The Rathaus is a **false head**. Officers may still keep an office there. Fair leftover: that building *was* the imperial post house (until 1855). **CAPT. ELLIS WARD** believes it is a real head. Cutting it does **not** count.
2. **The hydra has three heads.** Board (Altrathausplatz), loft (Grüner Turm), books with Brandt (Nördlinger Straße start). Cut **any two** and the hydra dies. Hitting one and leaving is a wounded hydra — partial or fail, not a hidden rule. The hydra rule **and the three types** are **handed at briefing**. **Locations** stay GM-copy until found. Ward pins the Rathaus as the exchange; it is a **false head**.
3. **The fuse is officers, not a hidden army.** Stein and Keller can escalate (curfew, hunt, a call if the hydra still lives). There is no off-map battalion waiting on one Stealth fail. Out-of-town help needs a living path **and** time. En-route flak does not wake this town.
4. **The drop misses.** Ward marked west / Segringer Tor. Weather and a dark DZ put them on the east / Wörnitz face, together. This is opening trouble, not a second twist. The dummy Rathaus remains the one twist.
5. **Standing fictions.** The raid, the hydra, the 4-person team, this briefing and night strip at Pont-à-Mousson, and women in ordinary combat ranks on both sides are invented. Dinkelsbühl’s walls, winter, rear-area quiet in January 1945, and Pont-à-Mousson as Allied rear are the researched frame. Players need the world rule (gender is not a question). They do not need a lecture on which facts are fake.

### Revelation audit (if they miss a vector)


| Essential revelation                              | Still reachable through                                                              |
| ------------------------------------------------- | ------------------------------------------------------------------------------------ |
| They are on the east face, not the rehearsed west | Water on the map vs water here; missing Segringer; Lang names Wörnitztor             |
| Briefing building is not the hydra                | Skyline / feed; leftover; they can still kill two real heads                         |
| Hydra has three heads                             | Observation of aerial + board + runner; hitting two obvious *real* sites still works |
| Where the switchboard is                          | Loft + papers still complete the job                                                 |
| Where the loft is                                 | Switchboard + papers still complete the job                                          |
| Where the papers are                              | Switchboard + loft still complete the job                                            |


## End states

- **Full success:** any two heads dead; papers useless if they were one of the two; officers not yet able to call real help; team leaves in the dark.
- **Costly success:** hydra dead; dawn, wounded, civilian harm, or a loud hunt on the way out.
- **Partial success:** only one head off; hydra wounded; a call may go out; extraction expensive; southern-front help delayed, not stopped.
- **Main-objective failure:** two heads still live, or papers plus one live path still pass traffic. They may still escape. The window of German coordination holds.
- **Unexpected resolution:** papers stolen instead of burned; an officer captured; the town bloodied; the dummy site blamed and the real net quiet for a night for the wrong reason. Record what actually happened; do not rewrite unused prep as history.
- **Rewards / advancement:** this table can stop here. If you continue these characters, grant **1 Advance** (SWADE p.54) after the recap. No loot that changes the night. Bennies reset next session.
- **Continuing hook (optional):** a call that got out; papers in Allied hands; a named officer who saw their faces. A one-shot does not need this.

Consequences to record after play: which heads died; whether a call went out; civilian harm; named officers’ fates; who left alive; any ruling made at the table. Dated recap — do not edit this file into history.

## Table checklist

- [x] Runtime header matches `ADVENTURE.md`.
- [x] Compile satisfies `templates/adventure/SKELETON.md`.
- [x] `QUALITY.md` is scored; band allows compile (98/120, named repairs in that file).
- [x] Coherence (prep) passed; logic summary present in QUALITY.md.
- [x] No inactive setting material appears.
- [x] Notation is filled and followed (ALL-CAPS first mentions; Trait tests with fail / success / raise).
...
- [x] First 15 minutes contain actual trouble, not only briefing.
- [x] Five-beat dashboard is filled and is not a visit order.
- [x] Climax situation has opposition, environment, urgency, and a secondary objective.
- [x] Pacing cuts are identified, including a 3–4 hour core for a one-shot.
- [x] End states include rewards or a clear stop, and a complete ending.
- [x] GM-only information is clearly marked.
- [x] No prepared event is described as though it already happened.
- [ ] Player briefing map marked at table start (planned DZ + Rathaus only). Actual LZ marked after they orient.

## After play - do not treat as prep

Create a dated session recap recording actual events, unresolved questions, rulings, character changes, and canon candidates. Reconcile those changes into the repository only after review.