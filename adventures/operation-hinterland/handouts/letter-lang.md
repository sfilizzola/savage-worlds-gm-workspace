# Call letter — Cpl. Beatrice "Bee" Lang
...
**YOUR ROLE:** Scout and field medic. Find the way in. Keep the bodies attached.  
...
Bee — if we may — try to keep the lieutenant from walking into the furniture, and the sergeant from turning the furniture into rubble. That is the job. The other job comes later.

*I have the honour to remain, etc.,*  
**Col. W. Harrow**  
Joint Operations Desk  
*P.S. The first-aid kit is for actual injuries. Crisps do not count, however sharp.*
